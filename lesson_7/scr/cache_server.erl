...
test() ->
	cache_server:start_link(dima, [{drop_interval, 600}]),
	cache_server:insert(dima, 1, 1, 600),
	cache_server:insert(dima, 2, 2, 600),
	cache_server:insert(dima, 3, 3, 600),
	cache_server:insert(dima, 4, 4, 600),
